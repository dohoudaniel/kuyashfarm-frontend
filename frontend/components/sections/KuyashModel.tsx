        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <svg
              ...
              aria-label="Kuyash Integrated Farm ecosystem diagram"
            >
              {/* ── orbit arc segments ── */}
              {arcPaths.map((d, i) => (
                <path
              ...
              <text x={CX} y={CY + 18} textAnchor="middle" fontFamily="'Georgia', serif" fontWeight="700" fontSize="11" fill="#2d5f3f" letterSpacing="1.5">KUYASH</text>
              <text x={CX} y={CY + 31} textAnchor="middle" fontFamily="'Georgia', serif" fontWeight="700" fontSize="11" fill="#2d5f3f" letterSpacing="1.5">INTEGRATED</text>
              <text x={CX} y={CY + 44} textAnchor="middle" fontFamily="'Georgia', serif" fontWeight="700" fontSize="11" fill="#2d5f3f" letterSpacing="1.5">FARM</text>
