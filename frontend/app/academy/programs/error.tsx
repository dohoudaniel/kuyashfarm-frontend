  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#faf8f5] px-4 pt-20">
      <div className="max-w-md text-center">
        ...
        <p className="mb-2 font-mono text-xs font-semibold uppercase tracking-widest text-[#6b9d7a]">
          Something went wrong
        </p>
        <h2 className="mb-3 font-serif text-2xl font-bold text-gray-900">
          Couldn&apos;t load the Course Catalog
        </h2>
        <p className="mb-8 font-sans text-sm leading-relaxed text-gray-500">
          We had trouble loading the programs. Please try again or go back to the Academy.
        </p>
