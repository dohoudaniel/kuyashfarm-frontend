      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2px_1fr] gap-0">
          ...
          >
            ...
            <h2 className="font-serif font-bold text-[#080f0a] leading-[1.1]"
            ...
            <p className="mt-4 font-serif italic"
              style={{ fontSize: "clamp(1.1rem, 1.8vw, 1.5rem)", color: "#2d5f3f" }}>
            ...
            <div className="mt-8 flex items-center gap-3">
              <div className="w-8 h-0.5 bg-[#2d5f3f]" />
              <div className="w-2 h-0.5 bg-[#c6dece]" />
              <div className="w-1 h-0.5 bg-[#eef5f1]" />
            </div>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center shrink-0 pt-1">
                    <span className="font-mono text-[11px] font-bold text-[#2d5f3f] tracking-widest">
                      {step.number}
                    </span>
                    {i < STEPS.length - 1 && (
                      <div className="w-px flex-1 bg-[#c6dece] mt-2 min-h-[32px]" />
                    )}
                  </div>

                  {/* Icon */}
                  <div className="w-10 h-10 rounded-xl bg-[#eef5f1] border border-[#c6dece] flex items-center justify-center shrink-0 group-hover:bg-[#2d5f3f] group-hover:border-[#2d5f3f] transition-all duration-300">
                    <Icon className="w-4 h-4 text-[#2d5f3f] group-hover:text-white transition-colors duration-300" />
                  </div>

                  {/* Content */}
                  <div className="flex-1">
                    <h3 className="font-serif font-bold text-[#080f0a] text-lg mb-1.5 group-hover:text-[#2d5f3f] transition-colors duration-200">
                      {step.title}
                    </h3>
                    <div className="flex flex-wrap gap-x-3 gap-y-0.5">
                      {step.lines.map((line, j) => (
                        <span key={j} className="text-sm text-gray-400 font-sans">
                          {line}
                        </span>
                      ))}
                    </div>
