  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="mb-8 text-center">
        <h3 className="mb-4 font-serif text-3xl font-bold text-primary md:text-4xl">{title}</h3>
      ...
      >
        ...
        <div className="absolute top-0 bottom-0 w-1 bg-white shadow-lg" style={{ left: `${sliderPosition}%` }}>
          <div className="absolute top-1/2 left-1/2 h-12 w-12 -translate-x-1/2 -translate-y-1/2 rounded-full border-4 border-white bg-primary shadow-xl">
