      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            ...
            <br />
            <span className="text-primary">their practice and income.</span>
          </motion.h2>
        </div>
            ...
            >
              ...
              <div className="flex gap-1">
                {Array.from({ length: 5 }).map((_, si) => (
                  <Star key={si} className="w-4 h-4 fill-wheat text-wheat" />
                ))}
              </div>

              {/* Quote */}
              <p className="font-serif text-lg text-primary-dark leading-relaxed flex-1">
                &ldquo;{t.quote}&rdquo;
              </p>
              ...
              <div className="flex items-center gap-4 pt-2 border-t border-gray-50">
                <div className="relative w-11 h-11 rounded-full overflow-hidden shrink-0 border-2 border-mist">
        ...
        >
          <div className="flex -space-x-3">
            ...
            <div className="w-10 h-10 rounded-full bg-primary border-2 border-white flex items-center justify-center shadow">
