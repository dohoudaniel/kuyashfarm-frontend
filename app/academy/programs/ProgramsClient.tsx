...
function ProgramCard({ program, index }: { program: CatalogProgram; index: number }) {
  ...
  const statusStyle: Record<string, string> = {
    ...
    "Sold Out":      "bg-gray-50 text-gray-500 border-gray-200",
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-gray-500 text-xs leading-relaxed font-sans mb-4 line-clamp-2">
          {program.summary}
        </p>
        ...
        <div className="mb-4">
          <div className="flex justify-between text-[10px] mb-1.5">
            <span className="text-gray-500">Practical training</span>
        ...
        <div className="flex items-center gap-3 mb-4 text-xs">
          <div className="flex items-center gap-1">
            ...
            <span className="text-gray-500">({program.reviewCount})</span>
          </div>
          <span className="text-gray-200">·</span>
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-gray-50">
          ...
          <div className="flex gap-2">
            ...
            {isAvailable ? (
              ...
              <span className="text-xs font-semibold text-gray-500 bg-gray-100 px-3 py-2 rounded-lg cursor-not-allowed">
                Apply
              </span>
            )}
          </div>
  ...
  return (
    <main className="bg-cream min-h-screen">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-7xl 2xl:max-w-[1536px] mx-auto px-6 md:px-12 lg:px-16 py-8">
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-xs text-gray-500 mb-5 font-sans">
          ...
          <div className="mt-6 relative">
            ...
            />
            {query && (
              <button onClick={() => setQuery("")} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-600">
                <X className="w-4 h-4" />
              </button>
            )}
          </div>
      ...
      <div className="max-w-7xl 2xl:max-w-[1536px] mx-auto px-6 md:px-12 lg:px-16 py-12 space-y-20">
        ...
        {!hasActiveFilters && (
          <section>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-xs text-gray-500 font-sans ml-1">— Our flagship training pathways</span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-500 text-xs leading-relaxed mb-4 line-clamp-2">{program.summary}</p>
        ...
        {!hasActiveFilters && (
          <section>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-xs text-gray-500 font-sans ml-1">— Recommended course journeys</span>
            </div>
              ...
              {LEARNING_PATHWAYS.map((pw, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-xs leading-relaxed mb-3">{pw.description}</p>
        ...
        {!hasActiveFilters && (
          <section>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-xs text-gray-500 font-sans ml-1">— Browse by the career you want</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 text-center">
              {CATALOG_STATS.map((s, i) => (
                <motion.div key={s.label} initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <p className="text-white/60 text-xs mt-1 font-sans">{s.label}</p>
                </motion.div>
              ))}
            </div>
          </section>
        ...
        <section>
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-24 bg-white rounded-3xl border border-gray-100">
              ...
              <p className="text-gray-500 text-sm font-sans mb-6">Try adjusting your filters or search query.</p>
        ...
        <section className="relative rounded-3xl overflow-hidden border border-white/10"
          ...
          <div className="relative z-10 px-8 md:px-14 py-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div>
              <p className="text-xs font-mono uppercase tracking-[0.2em] text-primary mb-3">Ready to enrol?</p>
